...
export default function EmergencyFoundVideosScreen() {
  ...
  return (
    <EmergencyFrame style={styles.frame}>
      ...
      <View style={styles.bottomArea}>
        ...
        <SoftAction text="Watch Related First aid videos" icon="play-circle-outline" onPress={() => router.push('/Emergency/choose')} />
