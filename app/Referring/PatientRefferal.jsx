    ...
    <SafeAreaView style={styles.safeArea}> 
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.container1}>
          ...
          <Text style={styles.buttonText1}>Enter Patient's Detail</Text>
...
export default PatientRefferal; // Exporting PatientReferral as requested